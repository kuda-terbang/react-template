...
export * from './layout/layout-client';
...
export { default as AutocompleteSmart } from './input/autocomplete/autocomplete-smart.view';
...
export { default as DropFilesSmart } from './input/drop-files/drop-files-smart.view';
export { default as InputFileSmart } from './input/input-file/input-file-smart.view';
...
export { default as TextEditorSmart } from './input/text-editor/text-editor-smart.view';
