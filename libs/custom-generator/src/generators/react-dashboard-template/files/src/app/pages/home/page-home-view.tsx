...
import apiStrapiService from '@<%= npmScope %>/data-access-strapi'
  ...
  return (
    <Box sx={{
      ...
      <Box component="form" sx={{
        ...
        <Typography variant="h2" component="h1">{websiteName}</Typography>
        {isAuthenticated ? (
          <>
            <Typography textAlign="center" variant="h5">Welcome</Typography>
            <Button onClick={handleLogout}>Logout</Button>
          </>
        ) : (
          <>
            <Typography textAlign="center" variant="h5">{isLogin ? 'Login' : 'Register'}</Typography>
