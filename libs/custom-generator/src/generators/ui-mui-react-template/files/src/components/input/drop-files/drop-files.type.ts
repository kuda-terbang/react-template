...
export type DropFilesProps = {
  ...
  onChangeFile: (acceptedFiles: AcceptedFile[], fileRejections?: FileRejection[], event?: DropEvent) => void
  onClickSubmit: (files: AcceptedFile[]) => void
  onClickRemove?: (index: number, file: AcceptedFile, e?: React.MouseEvent<HTMLButtonElement, MouseEvent>) => void
